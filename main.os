...
Процедура ПриНачалеРаботыСистемы() // BSLLS:UnusedLocalMethod-off
	...
	ИнициализироватьБД();
	НастроитьСоответствиеРесурсовИСущностей();
...
Процедура НастроитьСоответствиеРесурсовИСущностей()
	ХранилищеДанных.ДобавитьСоответствиеМаршрута("files", Тип("ДанныеОФайле"));
КонецПроцедуры